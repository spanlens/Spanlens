...
GET    /api/v1/webhooks/:id/deliveries    # Last 10 delivery records`}</CodeBlock>
      ...
      <CodeBlock language="bash">{`curl -X POST https://spanlens-server.vercel.app/api/v1/webhooks \\
...
app.post('/hooks/spanlens', express.raw({ type: 'application/json' }), (req, res) => {
  ...
  res.json({ ok: true })
      ...
      <CodeBlock language="bash">{`curl https://spanlens-server.vercel.app/api/v1/webhooks/wh_01j9abc.../deliveries \\
      ...
      <CodeBlock language="json">{`[
  {
    ...
    "delivered_at": "2026-05-15T09:01:24Z"
      ...
      <CodeBlock language="bash">{`curl -X POST https://spanlens-server.vercel.app/api/v1/webhooks/wh_01j9abc.../test \\
  -H "Authorization: Bearer <JWT>"`}</CodeBlock>
