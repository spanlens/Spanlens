...
const NAV: NavGroup[] = [
  ...
  },
  {
    title: 'Concepts',
    items: [
      { title: 'LLM observability', href: '/docs/concepts/llm-observability' },
      { title: 'Agent tracing', href: '/docs/concepts/agent-tracing' },
      { title: 'Evals', href: '/docs/concepts/evals' },
      { title: 'Prompt management', href: '/docs/concepts/prompt-management' },
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Flowise', href: '/docs/integrations/flowise' },
